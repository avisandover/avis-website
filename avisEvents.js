...
var avisEvents = [
	...
	shortDescription: 'Andover Ales & Trails: Hike along the Shawsheen River thorugh the Shawsheen and Vale Reservations and meet back at Oak and Iron',
	description: 'Hike along the Shawsheen River through the Shawsheen and Vale Reservations then meet back at Oak and Iron.  <a href="https://activities.outdoors.org/s/oc-activity/a5UUN00000221uv2AA/act00017801">Registration Opens Thursday, January 29, 2026 | 4:00 PM</a>',
	start: '2026-02-08T13:15',
    },
    {
	title: 'Andover Ales & Trails (AA&T)',
	location: 'Wood Hill / Bald Hill Reservations',
	shortDescription: 'Andover Ales & Trails: Hike – Wood Hill / Bald Hill Reservations and meet back at Oak and Iron',
	description: 'Hike Wood Hill/Bald Hill Reservations then meet back at Oak and Iron.  <a href="https://activities.outdoors.org/s/oc-activity/a5UUN0000024cjt2AA/act00018026">Registration Opens Thursday, February 5, 2026 | 4:00 PM</a>',
	start: '2026-02-15T13:15',
    },
    {
	title: 'Andover Ales & Trails (AA&T)',
	location: 'Bay Circuit Trail and the Charles Ward Reservation',
	shortDescription: 'Andover Ales & Trails: Bay Circuit Trail and the Charles Ward Reservation and meet back at Oak and Iron',
	description: 'Hike Bay Circuit Trail and the Charles Ward Reservation then meet back at Oak and Iron.  <a href="https://activities.outdoors.org/s/oc-activity/a5UUN0000024cvB2AQ/act00018027">Registration Opens Thursday, February 12, 2026 | 4:00 PM</a>',
	start: '2026-02-22T13:15',
    },
    {
	title: 'Try Exploring Andover (TEA) Time',
	location: 'Den Rock Park and Bird Sanctuary',
	shortDescription: 'TEA Time Hike around Den Rock Park and Bird Sanctuary',
	...
	shortDescription: 'TEA Time Hike through the Charles Ward Reservation',
	...
	shortDescription: 'TEA Time Hike along Deer Jump and Harold Rafton Reservations',
	...
	shortDescription: 'TEA Time Hike from Harold Parker State Forest to Skug River Reservation',
	...
	shortDescription: 'TEA Time Hike along Bay Circuit Trail Andover to Tewksbury Spur',
	...
	shortDescription: 'TEA Time Hike around Harold Parker State Forest Stearns & Sudden Ponds',
...
//    },
	...
	shortDescription: 'TEA Time Hike around Boxford State Forest in North Andover',
	...
	shortDescription: 'TEA Time Hike along the Shawsheen River through the Shawsheen and Dale Reservations',
  ...
  function toClockRange(startHours,startMinutes,endHours,endMinutes) {
      var clockTime = "";
      var startSuffix = "";
      var endSuffix = "";
      if (isNaN(endHours)) {
      ...
      } else if (startHours < 12 && endHours < 12) {
	  endSuffix = " am";
      } else if (startHours < 12 && endHours >= 12) {
	  startSuffix = " am";
	  endSuffix = " pm";
      ...
      clockTime += (startHours > 12) ? (startHours-12) : (startHours);
      clockTime += ':';
      clockTime += (startMinutes < 10) ? ("0"+startMinutes.toString()) : (startMinutes.toString());
      clockTime += startSuffix;
      if (! isNaN(endHours)) {
	  clockTime += ' - ';
	  clockTime += (endHours > 12) ? (endHours-12) : (endHours);
	  clockTime += ':';
	  clockTime += (endMinutes < 10) ? ("0"+endMinutes.toString()) : (endMinutes.toString());
      }
      clockTime += endSuffix;
      return clockTime;
  }
  
  function toAvisDate(start,end) {
      s = new Date(start)
      e = new Date(end)
      return dayName[s.getDay()]+'<br/>'+monthName[s.getMonth()]+' '+s.getDate()+', '+s.getFullYear()+'<br/>'+toClockRange(s.getHours(),s.getMinutes(),e.getHours(),e.getMinutes());
  }

function toShortDate(start) {
    s = new Date(start)
    return dayName[s.getDay()]+', '+monthName[s.getMonth()]+' '+s.getDate()+', '+s.getFullYear();
}
